...
You may not use the Onesto Application or accept these Application Terms, if (a) you are not at least 18 years of age; (b) you are not legally capable of entering into binding contracts, or you do not have legal capacity to do so; (c) you are prohibited by law from receiving or using the Onesto Application; (d) you are not an Australian resident or (e) you do not have a valid and verifiable email address and Australian mobile phone number.

**2. Collection Notice**

We collect personal information about you in order to provide you with Onesto’s services, including the provision of our Advanced Wages Service, to respond to your enquiries, and to provide you full access to the Onesto Application and for purposes otherwise set out in our Privacy Policy at privacy@onesto.co.
  ...
  return (
    ...
    <article className="max-w-4xl mx-auto px-4 py-8">
      <header className="mb-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Bapcor Employee Benefits – Terms and Conditions</h1>
      </header>
