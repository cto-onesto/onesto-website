        ...
        <section className="container py-12 sm:py-20">
            <article className="max-w-4xl mx-auto px-4 py-8">
                <header className="mb-8">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">One Member Benefits – Application Terms and Conditions</h1>
                </header>
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">1. Registration</h3>
                        <p className="mb-4">
                        ...
                        <p>
                            You may not use the Application or accept these Application Terms, if (a) you are not at least 18 years of age; (b) you are not legally capable of entering into binding contracts, or you do not have legal capacity to do so; (c) you are prohibited by law from receiving or using the Application; (d) you are not an Australian resident or (e) you do not have a valid and verifiable email address and Australian mobile phone number.
                        </p>
                    </div>

                    <div>
                        <h3 className="text-xl font-bold mb-4">2. Collection Notice</h3>
                        <p className="mb-4">
                            We collect personal information about you in order to provide you with our services and to respond to your enquiries, and to provide you full access to the Application and for purposes otherwise set out in our Privacy Policy at privacy@onesto.co.
                        </p>
                        <p className="mb-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">3. Accuracy, completeness and timeliness of information</h3>
                        <p className="mb-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">4. Purchases</h3>
                        <p>
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">5. Linked Sites</h3>
                        <p>
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">6. Intellectual Property Rights</h3>
                        <p className="mb-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">7. No Commercial Use</h3>
                        <p>
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">8. Unacceptable Activity</h3>
                        <p className="mb-4">
                        ...
                        <ul className="list-disc list-inside space-y-2 mb-4">
                            ...
                            <li>using this Application to defame or libel us, our employees or other individuals;</li>
                            <li>uploading files that contain viruses that may cause damage to our property or the property of other individuals;</li>
                            <li>posting or transmitting to this Application any non-authorised material including, but not to, material that is, in our opinion, likely to cause annoyance, or which is defamatory, racist, obscene, threatening, pornographic or otherwise or which is detrimental to or in violation of our systems or a third party’s systems or network security.</li>
                        </ul>
                        <p>
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">9. Warranties and Disclaimers</h3>
                        <p className="mb-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">10. Liability</h3>
                        <p>
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4">11. Jurisdiction and Governing Law</h3>
                        <p>
