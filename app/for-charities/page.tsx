    ...
    <div className="bg-transparent text-gray-800">
      ...
      <Section className="bg-transparent">
        <div className="container mx-auto px-6 text-center">
          <Badge variant="secondary" className="bg-accent/10 text-green-500 border-accent/20 px-4 py-2 rounded-full font-semibold">
            One Philanthropic
          </Badge>
          <motion.h1
          ...
          >
            Empower Your Cause with <span className="text-green-500">One Philanthropic</span>
          </motion.h1>
          <motion.p
            variants={itemVariants}
          ...
          >
            <Button asChild size="lg" className="bg-green-500 hover:bg-green-500/90 text-white shadow-lg hover:shadow-xl transition-all duration-300">
              <Link href="/contact">Partner with Us Today</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-green-500 text-green-500 hover:bg-green-500/5 transition-all duration-300">
      ...
      <Section className="py-16 sm:py-24 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold text-gray-900">
            What <span className="text-green-500">One Philanthropic</span> Delivers
          </motion.h2>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex justify-center mb-6">
                <Handshake className="h-16 w-16 text-green-500 animate-pulse" />
              </div>
            ...
            >
              <div className="flex justify-center mb-6">
                <BarChart className="h-16 w-16 text-green-500 animate-pulse" />
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div variants={itemVariants}>
              ...
              <p className="mt-2 text-3xl md:text-4xl font-bold tracking-tight text-gray-900 leading-tight">
                Our Mission: <span className="text-green-500">Impact Without Burden</span>
              </p>
            ...
            <motion.div variants={itemVariants} className="mt-8 md:mt-0 relative flex justify-center">
              <Image
                src="/uniting.png" // Placeholder image for mission
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              How <span className="text-green-500">One Philanthropic</span> Transforms Support
            </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <motion.div variants={itemVariants} className="mt-8 md:mt-0 relative">
                <Image
                  src="/donations-img-2.png" // Placeholder image
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <motion.div variants={itemVariants} className="relative">
                <Image
                  src="/partner-one.png" // Placeholder image
      ...
      <Section className="bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold text-gray-900">
              Saving & Donating <span className="text-green-500">Naturally</span> with One Philanthropic
            </motion.h2>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                <ShoppingBag className="h-10 w-10 text-green-500 mr-3" />
            ...
            >
              <div className="flex items-center mb-4">
                <PiggyBank className="h-10 w-10 text-green-500 mr-3" />
            ...
            >
              <div className="flex items-center mb-4">
                <Eye className="h-10 w-10 text-green-500 mr-3" />
      ...
      <Section>
        <div className="container mx-auto px-6">
          <div className="bg-transparent rounded-2xl p-8 md:p-12 lg:p-16">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <motion.div variants={itemVariants}>
                <div className="inline-flex items-center bg-green-500-light text-green-500 rounded-full p-3 mb-6 shadow-md">
                  <CreditCard className="h-8 w-8" />
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-4">Instant Impact: <span className="text-green-500">Automated Gift Cards</span> for Those in Need</h2>
                <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                ...
                <p className="mt-4 text-lg text-gray-600 font-semibold">
                  Plus, your NFP earns up to <span className="text-green-500">10% cashback</span> from every gift card purchase, further boosting your funds!
                </p>
              </motion.div>
              <motion.div variants={itemVariants} className="mt-8 md:mt-0 relative">
                <Image
      ...
      <Section>
        <div className="container mx-auto px-6 text-center">
          <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold text-gray-900">
            Revolutionize Your Fundraising with <span className="text-green-500">Onesto's Philanthropic Benefits</span>
          </motion.h2>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex justify-center mb-6">
                <PiggyBank className="h-12 w-12 text-green-500 animate-bounce" />
              </div>
            ...
            >
              <div className="flex justify-center mb-6">
                <Shield className="h-12 w-12 text-green-500 animate-bounce" />
              </div>
      ...
      <Section className="bg-gradient-to-br from-green-600 to-green-800 text-white">
        <div className="container mx-auto px-6 text-center py-16">
          ...
          <motion.div variants={itemVariants} className="mt-10">
            <Button asChild size="lg" className="bg-white text-green-600 hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
