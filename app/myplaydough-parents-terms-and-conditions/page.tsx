...
1. 2.  **Collection Notice**

We collect personal information about you in order to provide you with Onesto’s services, including the provision of our Shop to Save Service, to respond to your enquiries, and to provide you full access to the Application and for purposes otherwise set out in our Privacy Policy at privacy@onesto.co.
  ...
  return (
    ...
    <article className="max-w-4xl mx-auto px-4 py-8">
      <header className="mb-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">My PlayDough Parents – Terms and Conditions</h1>
      </header>
