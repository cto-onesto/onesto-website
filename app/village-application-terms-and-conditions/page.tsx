  ...
  return (
    ...
    <article className="max-w-4xl mx-auto px-4 py-8">
      <header className="mb-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Village Employee Benefits – Terms and Conditions</h1>
      </header>
