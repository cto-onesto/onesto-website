...
These terms of service (“Terms of Service”) pertain to the My PlayDough – Parents Platform (“Platform”, as defined below) and constitute a legal agreement between you and Pay Me Now Please Pty Ltd trading as Onesto Australia (“Onesto”). As used in these Terms of Service, the words “you” and “your” refer to you, the user of the Platform (as defined below), as the party agreeing to these Terms of Service. The words “we”, “us”, “our” and any other variation thereof refer to Onesto. Any reference to “Onesto” in this document includes our directors, officers, employees, contractors, and owners. As used in these Terms of Service, the term “Platform” includes all platforms associated with My PlayDough -Parents Application, and websites linked to the My PlayDough – Parents Application (either to access the Application or websites that are linked to the Application) and all devices or applications that we operate that link to these Terms of Service, pages within each such website, device, or application, any equivalent, mirror, replacement, substitute or backup website, device, or application, and pages that are associated with each such website, device, or application. The use of the word “including” in these Terms of Service to refer to specific examples will be construed to mean “including, without limitation” or “including but not limited to” and will not be construed to mean that the examples given are an exclusive list of the topics covered. 
...
After agreeing to these terms of service and privacy policy, you will have two (2) virtual accounts set up and accessible via the Platform – your “Shopping Account” and your “Savings Account” (collectively “Virtual Accounts”). Each of these Virtual Accounts will have their own Pay ID, and or/BSB and account number. These Virtual Accounts are provided by our third-party payment provider, Zepto Payments Pty Ltd (“Zepto”).

You acknowledge that you must accept the Zepto’s terms and conditions as contained in Zepto’s website, and updated and amended from time to time, before using their payment services, and that Zepto’s terms and conditions are hereby incorporated into these Terms of Use. The links to Zepto’s website and relevant web pages are listed as follows for your reference:

* *   [https://www.zepto.com.au](https://www.zepto.com.au/)
...
1. 1.  can be used to purchase services or merchandise from suppliers;
1. 2.  may not be redeemable for cash;
1. 3.  prominently displays either the expiration date or the number of months following purchase that such card or mechanism expires.
...
For information about our privacy and data protection practices, please read Onesto’s Privacy Policy, which is available to access and view on the Onesto Platform at [www.onesto.co/privacy-policy](http://www.onesto.co/privacypolicy)

Our Privacy Policy explains how we manage personal information you provide to us when you access and use the Platform. The types of personal information which we collect to enable us to provide our services to you are detailed at clause 6 below.

At all times we aim to protect the privacy of your personal information, maintain your rights in relation to your personal information managed by us, and ensure we collect, hold, use and disclose your personal information in accordance with its obligations under the Privacy Act 1988 (Cth) (**Privacy Act**), the 13 Australian Privacy Principles in the Privacy Act and all other relevant Australian privacy laws.  The ways in which we seek to achieve these aims, and satisfy its obligations, are detailed in our Privacy Policy.  Your acceptance of these Terms of Service constitutes an acceptance of Onesto’s Privacy Policy.

Our Privacy Policy may be updated, amended and/or replaced in whole or in part from time to time at our absolute discretion and any updates, amendments or replacements will be effective from the time they are posted to the Platform.
...
If you believe that Your Information, or a device that you use to access the Platform, has been lost or stolen, that someone is using your account without your permission, or that an unauthorised transaction has occurred on your account, you must notify us immediately at [support@myplaydough.com.au](mailto:support@myplaydough.com.au).
...
If you have opened an account with us and you wish to withdraw your consent to have Communications provided electronically, you must close your account by contacting us at support@myplaydough.com.au. and stop using the My PlayDough – Parents Platform. There are no fees to close your account with us. Any withdrawal of your consent to receive electronic Communications will be effective only after we have a reasonable period of time to process your withdrawal and only after all outstanding transactions have been settled.
...
Email: [support@myplaydough.com.au](mailto:support@myplaydough.com.au) – addressed to the Head of Legal

Mail: Unit 1/60 Toorak Rd, South Yarra VIC 3141
...
1. 1.  Resolved the complaint to your satisfaction within 5 business days; or
1. 2.  Given you an appropriate explanation and/or apology and there are no further actions we can reasonably take to address the complaint.
...
1. 1.  We have provided you with a formal response; or
1. 2.  At least twenty (20) business days (or the timeframe outlined by AFCA) has elapsed since you made the complaint
`;
  return (

    <article className="max-w-4xl mx-auto px-4 py-8">
      <header className="mb-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">My PlayDough – Parents – Terms of Service</h1>
      </header>
